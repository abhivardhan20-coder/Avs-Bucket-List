 ...
 */
export async function buildUserTaste(watched: WatchedItem[]): Promise<UserTaste> {
...
export const recommendationEngine = {
  getRecommendations: (watched: WatchedItem[], watchlist: any[], pool: MediaItem[] = []): MediaItem[] => {
    const genreScores: Record<string, number> = {};
    const castCount: Record<string, number> = {};
    const directorCount: Record<string, number> = {};
    const genreRatings: Record<string, number[]> = {};
