...
import TimeSpentCard from '@/components/stats/TimeSpentCard';
...
import {
  ...
  getActivityTimeline,
  checkAchievements
} from '@/components/stats/StatsHelpers';
...
const GenrePieChart = React.lazy(() => import('@/components/stats/GenrePieChart'));
const TopPeopleChart = React.lazy(() => import('@/components/stats/TopPeopleChart'));
const ActivityTimeline = React.lazy(() => import('@/components/stats/ActivityTimeline'));
